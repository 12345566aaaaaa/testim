    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="bg-white dark:bg-slate-900 p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 dark:border-slate-800 w-full max-w-[500px]">
        ...
        <div className="flex flex-row items-center gap-5 border-b border-gray-100 dark:border-slate-800 pb-8 mb-8">
          ...
          <div className="flex flex-col text-left">
            <h1 className="text-2xl font-extrabold tracking-tight leading-tight">
              <span className="text-[#1a5f7a] dark:text-[#38bdf8]">Rivendos</span>
              <span className="text-[#f59e0b]"> Fjalëkalimin</span>
            </h1>
            <p className="text-gray-400 dark:text-slate-500 text-xs mt-1 font-bold uppercase tracking-widest">Shkruani email-in tuaj</p>
          </div>
        </div>

        <form onSubmit={handleReset} className="space-y-6">
          <div>
            <label className="block text-xs font-bold text-gray-500 mb-2 ml-1 uppercase">Email Adresa</label>
            <input 
              type="email" 
              required 
        ...
        <p className="text-center text-xs text-gray-400 dark:text-slate-500 mt-8 pt-6 border-t border-gray-50 dark:border-slate-800">
          U kujtuat? <a href="/" className="text-[#1a5f7a] dark:text-[#38bdf8] font-bold hover:underline">Kthehu te Login</a>
        </p>
